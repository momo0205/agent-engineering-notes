...
本专题只链接官方 arXiv 固定版本，不重新托管 PDF。阅读时请在相应论文页打开 abstract 与 PDF；版本号是引用的一部分。完整的代码、测试、下载元数据和原始学习材料属于公开的 [paper-deep-dive 固定提交](https://github.com/momo0205/paper-deep-dive/tree/2b8b41e63608725e6d4f25a44599014b1c22596e)。网站内容是在该提交于 2026-09-17 复核后人工挑选的表达层，并不会随着仓库后续变化自动改变。
