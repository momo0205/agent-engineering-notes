...
在 [paper-deep-dive 固定提交](https://github.com/momo0205/paper-deep-dive/tree/2b8b41e63608725e6d4f25a44599014b1c22596e) 中，以下命令运行一个小型 attention 检查。它用离线输入检查张量路径与基本行为，不下载数据集，也不训练机器翻译模型。
